define(['lib/news_special/bootstrap'], function (news) {
    ...
    Quiz.prototype = {
        ...
        getFirstQuestion: function () {
            ...
            news.pubsub.emit('quiz:showQuestion', [first.question, first.options, first.supportingText, first.feedback]);
        ...
        nextQuestion: function () {
            if ((this.currentQuestion + 1) > this.totalNumberOfQuestions) {
                ...
                this.currentQuestion += 1;
                news.pubsub.emit('quiz:showQuestion', [next.question, next.options, next.supportingText, next.feedback]);
                news.pubsub.emit('quiz:progress', [this.currentQuestion, this.totalNumberOfQuestions]);
            }
        },
