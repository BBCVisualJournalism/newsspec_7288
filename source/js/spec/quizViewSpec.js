define(['lib/news_special/bootstrap', 'quiz_view'],  function (news, View) {
    ...
    describe('view', function () {
        ...
        it('renders a question correctly', function () {
            ...
            expect(myView.elm.find('.quiz--supporting-text--generic').html()).toContain('programmers should know what a foo is');
        ...
        it('should show the supporting text and next button when an option is chosen', function () {
            ...
            news.pubsub.emit('quiz:showQuestion', [
                ...
                [
                    'Well, seeing as there was only one option, you had it pretty easy.'
                ],
                'programmers should know what a foo is'
            ]);
        ...
        it('renders the end of the quiz correctly', function () {
            ...
            expect(myView.elm.find('.quiz--score').html()).toContain('You rated 9 out of 100');
