...
module.exports = function (grunt) {
    grunt.initConfig({
        ...
        replace: {
            fixVocabs: {
                ...
                overwrite: true,
                replacements: [{
                    from: '&#44;',  // fix google spreadsheet misinterpreting commas
                    to:   ','
                }, {
                    from: '£',      // prepare for browser
                    to:   '&pound;'
                }, {
                    from: '’',
                    to:   '\''
    ...
    grunt.registerTask('previewstage',       ['project_checklist',               'add_environment_data', 'prepDeploy', 'replace:prepPreviewStageDeploy', 'copy:stageDeploy', 'clean:main']);
    ...
    grunt.registerTask('make_vocabs', ['add_environment_data', 'cloudfile_to_vocab', 'replace:fixVocabs']);
